...
open class TableAdapterCallbacks {
    ...
    public typealias CanMoveRow = (UITableView, IndexPath, TableData) -> Bool
    public typealias MoveDestinationRow = (UITableView, IndexPath, IndexPath, TableData, TableData?) -> IndexPath
    public typealias CommitMoveRow = (UITableView, IndexPath, IndexPath, TableData, TableData?) -> Void
    ...
    private(set) var canMoveRow: CanMoveRow?
    private(set) var commitMoveRow: CommitMoveRow?
    private(set) var moveDestinationRow: MoveDestinationRow?
    ...
    public func setCanMoveRow(_ block: CanMoveRow?) {
        canMoveRow = block
    }

    public func setCommitMoveRow(_ block: CommitMoveRow?) {
        commitMoveRow = block
    }

    public func setMoveDestinationRow(_ block: MoveDestinationRow?) {
        moveDestinationRow = block
    }
}
